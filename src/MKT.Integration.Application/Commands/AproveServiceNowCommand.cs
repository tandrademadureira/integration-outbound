...
{
    public class AproveServiceNowCommand
    {
        public class AproveServiceNowContract : BaseCommand<Result>
        {
            public SolicitacaoFornecedorDto solicitacaoFornecedor { get; set; }
        }

        public class Handler : BaseHandler<AproveServiceNowContract, Result>
        {
            ...
            public override async Task<Result> Handle(AproveServiceNowContract request, CancellationToken cancellationToken)
            {
                ...
                UpdateRequest updateRequest = new UpdateRequest(request.solicitacaoFornecedor.IdIntegracaoSistemaChamado, 6,
